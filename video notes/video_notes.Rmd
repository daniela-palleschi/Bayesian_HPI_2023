...
- this model can also be written for a linear model, where rt_{n} = some intercept ($\mu$) + noise ($\varepsilon$), where the residuals of the noise have a normal distribution ($iid$ means 'indepednent and identically distributed')
